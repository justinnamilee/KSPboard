...
* ## Arduino Side
  ...
  * Will eventually use an I/O expansion board, but for now has support for four chosen actions (using the remaining digital I/O pins) in addition to the joystick.  These are configured with the opPin array. __Pins 3-6__.
